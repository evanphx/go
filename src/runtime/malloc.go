...
const (
	...
	heapAddrBits = (_64bit*(1-(goarch.IsWasm|goarch.IsWasm32))*(1-goos.IsIos*goarch.IsArm64))*48 + (1-_64bit+(goarch.IsWasm|goarch.IsWasm32))*(32-(goarch.IsMips+goarch.IsMipsle)) + 40*goos.IsIos*goarch.IsArm64
